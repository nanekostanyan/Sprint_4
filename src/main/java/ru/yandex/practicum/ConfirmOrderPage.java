...
public class ConfirmOrderPage {
    ...
    private final By confirmOrderPage = By.cssSelector(".Order_Modal__YZ-d3");
    private final By confirmOrderButton = By.xpath(".//div[starts-with(@class,'Order_Buttons')]/button[text()='Да']");
