...
public class DoneOrderPage {
    ...
    private final By doneOrderPage = By.xpath(".//div[starts-with(@class,'Order_ModalHeader') and text()='Заказ оформлен']");
    ...
    public void waitToLoad() {
        WebElement element = new WebDriverWait(driver, EnvConfig.WEB_DRIVER_WAIT_TIMEOUT)
                .until(ExpectedConditions.visibilityOfElementLocated(doneOrderPage));
